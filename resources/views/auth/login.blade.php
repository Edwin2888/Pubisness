            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                        ...
                        <input type="email" autocomplete="off" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Correo') }}">
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-right">
                        <h6>
                            <a href="{{ route('password.request') }}" class="link footer-link">{{ __('¿Olvido contraseña?') }}</a>
                        </h6>
                    </div>
                </div>
            </div>
